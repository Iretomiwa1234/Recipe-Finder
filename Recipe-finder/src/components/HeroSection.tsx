  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center p-4 max-w-4xl mx-auto">
        ...
        {/* Subtext */}
        <p className="text-base sm:text-lg md:text-xl text-cream mb-8 pt-6 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            asChild 
            size="lg" 
            className="bg-primary hover:bg-primary/90 text-white px-6 py-2 text-base sm:text-lg"
          >
          ...
          <Button 
            ...
            size="lg" 
            variant="outline" 
            className="border-primary text-primary hover:bg-primary hover:text-white px-6 py-2 text-base sm:text-lg"
          >
